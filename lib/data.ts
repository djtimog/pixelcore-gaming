...
export const Tournaments = [
  {
    ...
    title: "Africa Codm EU",
    prize: 10000,
    game: "Call of Duty Mobile (CODM)",
    players: 30,
    time: "3:27 PM",
    date: "Nov 28, 2025",
    host: "John Doe",
  ...
  },
  {
    ...
    host: "Ayesha Cruz",
    rules: [
      "All players must be ranked Mythic or higher",
      "Streaming delay must be enabled",
    ],
    detailsLink: "#",
    applyLink: "#",
    hostLink: "#"
